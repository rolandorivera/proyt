...
<html>
  <head>
    ...
    <link href="{{asset('css/fuente.css')}}" media="all" rel="stylesheet" type="text/css" />
          ...
          <div class="nav-collapse">
            <ul class="nav">
              ...
              <li class="dropdown"><a class="current" data-toggle="dropdown" href="#">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="{{route('procesos.index')}}">Control de Proceso de Pago</a>
                  </li>
                  <li>
                    <a href="{{route('facturas.index')}}">Control de Facturas</a>
                  </li>
                  <li>
                    <a href="{{route('indexPro')}}">Control de Pagos</a>
                  </li>
                </ul>
              </li>
