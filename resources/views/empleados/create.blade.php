    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color:   #e9eaf4   ;">
                ...
                <h4 class="modal-title"> <i class="fa fa-plus-square-o"></i> Crear Empleado</h4>
            </div>
              ...
              <div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  <div class="form-group">
                    ...
                    {{Form::text('name',null,['class'=>'form-control','id'=>'name','placeholder'=>'Nombre del empleado', 'required'=>'','autocomplete'=>'off','autofocus'=>''])}}
                    @if($errors->has('name'))
                      <div>
                        <ul>
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  <div class="form-group">
                    ...
                    {{Form::text('lastName',null,['class'=>'form-control','id'=>'lastName', 'placeholder'=>'Nombre del empleado', 'required'=>'','autocomplete'=>'off','autofocus'=>''])}}
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  ...
                  {!! Form::date('admission', \Carbon\Carbon::now(),['class'=>'form-control', 'id'=>'admission', 'placeholder'=>'Fecha de Registro del empleado','required'])!!}
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="afp" id="afp" class="form-control" placeholder="AFP" required autocomplete="off" autofocus data-inputmask="'mask': ['999999999999']">
                        @if($errors->has('lastName'))
                          <div>
                            <ul>
                      ...
                      <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="isss" id="isss" class="form-control" placeholder="ISSS" required autocomplete="off" autofocus data-inputmask="'mask': ['999999999']">
                          @if($errors->has('lastName'))
                            <div>
                              <ul>
                          ...
                          <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                              <div class="form-group">
                                ...
                                {{Form::text('salary',null,['class'=>'form-control','id'=>'salary', 'placeholder'=>'Salario del empleado', 'required'=>'','autocomplete'=>'off','autofocus'=>''])}}
                              ...
                              <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                ...
                                <div class="col-lg-11 col-sm-11 col-md-11 col-xs-12">
                                  <div class="form-group">
                                    {!! Form::label('file','PDF')!!}
                                    {!! Form::file('input-file',null,['class'=>'form-control', 'placeholder'=>'Seleccione una PDF'])!!}
                                    </div>
                                  </div>
                              </div>
                            </div>
