<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-edit-{{$po->id}}">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header" style="background-color:#e9eaf4;">
        ...
        <h4 class="modal-title"><i class="fa fa-edit "></i> Editar Factura: {{ $po->numberBill }}</h4>
      </div>
  {!! Form::model($po, ['route' => ['empleados.update',  $po->id], 'files' => true, 'method' => 'PUT']) !!}
    ...
    <div class="row">
      ...
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <div class="form-group">
          ...
          <select class="form-control" name="processes_id" id="processes_id" required disabled>
      ...
      <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
        ...
        {!! Form::date('admission', $po->admission,['class'=>'form-control', 'id'=>'admission', 'placeholder'=>'Fecha de Registro del la factura','required'])!!}
      ...
      <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
        <div class="form-group">
          ...
          {{ Form::text('numberBill',$po->numberBill,['class'=>'form-control','id'=>'numberBill', 'placeholder'=>'Numero de Factura', 'required'=>'','autocomplete'=>'off','autofocus'=>'']) }}
      ...
      <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
        <div class="form-group">
          ...
          {{ Form::text('tot',$po->tot,['class'=>'form-control','id'=>'tot', 'placeholder'=>'Total', 'required'=>'','autocomplete'=>'off','autofocus'=>'','disabled'=>'']) }}
