<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$dep->id}}">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      {!! Form::open(['route' => ['departamentos.destroy',$dep->id],'method' => 'DELETE']) !!}
      <div class="modal-body">
        <p>Confirme si desea dar de baja jefe del departamento: <strong>{{ $dep->name}}</strong></p>
      </div>
